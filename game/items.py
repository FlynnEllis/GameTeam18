...
beefburger = consumable('beefburger','a beefburger','A wonderous creation.',4.2,1,-1)
...
burger = item('burger', 'a burger', 'dripping with grease and probably undercooked, is it really a good idea to eat this?',4,3)
