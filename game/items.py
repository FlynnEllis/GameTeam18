...
rum_coke = consumable('rnc','a rum and coke','Suboptimal drink.',4.2,3,2)
gin_tonic = consumable('gnt','a gin and tonic','Mature student?',4.2,3,2)
vodka_shot = consumable('vshot','a shot of vodka','Bread and butter of a night out.',4.2,2,2)
...
dark_fruits = consumable('df','a can of dark fruits','Reminds you of your year 10 campouts.',4.2,3,2)
red_stripe = consumable('rs','a can of red stripe','Jamaican you drunk',4.2,3,2)
pint_brains = consumable('brains','a pint of brains','You unleash your inner welshman.',4.2,2,2)
bloody_mary = consumable('bloody','a bloody mary cocktail','A questionable decision.',4.2,4,2)
...
chicken_nuggets = consumable('nuggets','a chicken nuggets','You hope it\'s chicken.',4.2,4,-2)
...
irish_disco_biscuit = consumable('idb','an irish disco biscuit','I think I know someone who would enjoy this...',4,4,3)
