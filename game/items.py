...
gin_tonic = consumable('gin tonic','a gin and tonic','Mature student?',4.2,3,2)
vodka_shot = consumable('vodka shot','a shot of vodka','Bread and butter of a night out.',4.2,2,2)
...
dark_fruits = consumable('dark fruits','a can of dark fruits','Reminds you of your year 10 campouts.',4.2,3,2)
red_stripe = consumable('red stripe','a can of red stripe','Jamaican you drunk',4.2,3,2)
pint_brains = consumable('brains','a pint of brains','You unleash your inner welshman.',4.2,2,2)
bloody_mary = consumable('bloody mary','a bloody mary cocktail','A questionable decision.',4.2,4,2)
...
mayo_chicken = consumable('mayo chicken','a mayo chicken','Chicken slathered in mayo.',4.2,1,-1)
