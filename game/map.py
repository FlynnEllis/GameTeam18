...
the room seems to be in good spirits. The music in the room appears to be 
Grime Time, which you should have expected by now. From across the room you 
see your squad and go over to get this party started. 
Now do you choose to go hard and drink an alcoholic concoction
or stay sober and have a coke?""")
...
room_bed = room(
    ...
    [],
    {},
    """You are now known amongst your friends as the flaker, passive aggressive 
...
From across the room you can see half the people trying 
not to suffocate from the foam and the other half trying to not look like a
cardboard cut-out. The music appears to be 80s hits, which you seem to enjoy.
...
room_student_union_dancefloor =  room(
    ...
    [],
    {},
    """The floor is sticky with less fortunate VK's than yours, they have a good owner. 
You awkwardly sway to the tunes, swigging on your VK occaisionally to blend in.
...
room_student_union_bar =  room(
    ...
    """After queing for at least half an hour you make it to the bar. As the pressure
of the people pushing on you grows you manage to shout VK breathlessly at the 
bartender. He asks what colour and you desperately gesture at the fridge.
...
what that life is you are never sure. You can choose to enter this uncommon
occurrence or leave for yet another cesspool. """)
...
The club is packed and there is a lot of creepy guys looking at girls. 
If you would like to join in and lose all sense of pride 
and eventually enter the depths of hell, proceed and enter to the bar 
...
room_pryzm_bar =  room(
    ...
    """You hope you brought enough gold bullion with you as you approach the pryzm bar. 
The bartender spins bottles around fancily whilst pouring the last order. 
I guess spirits are the order of the night here.""")
...
out the lyrics to the best of your ability. Perhaps you should work on those 
high notes.""")
...
The welsh national anthem comes on and you try your best to move your mouth to match the funny sounds
whilst you wait for your order.
""")
